...
public class BanidoDTO {
	...
	public BanidoDTO(Long id, String nome, String tipo, String planeta, String poder, MembroDTO membro) {
		this.id = id;
		this.nome = nome;
		this.tipo = tipo;
	...
	public BanidoDTO(Banido entity) {
		id = entity.getId();
		nome = entity.getNome();
		tipo = entity.getTipo();
		planeta = entity.getPlaneta();
		poder = entity.getPoder();
		membro = new MembroDTO(entity.getMembro());
	}
